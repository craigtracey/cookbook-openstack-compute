...
recipe "openstack-compute::nova-common", "Builds the basic nova.conf config file with details of the messaging, database, image and identity servers"
recipe "openstack-compute::nova-setup", "Sets up the nova database, including the initial schema and subsequent creation of the appropriate networks"
