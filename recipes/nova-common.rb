...
vnc_bind_ip = interface_ip node["openstack"]["compute"]["libvirt"]["bind_interface"]
xvpvnc_proxy_ip = interface_ip node["openstack"]["compute"]["xvpvnc_proxy"]["bind_interface"]
novnc_proxy_ip = interface_ip node["openstack"]["compute"]["novnc_proxy"]["bind_interface"]
